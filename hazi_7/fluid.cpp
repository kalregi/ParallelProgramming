...
int main(int argc, char **argv) {
    ...
    for (int j = 0; j < nx1 + 4; j++) {
        for (int i = 2; i < 3; i++) {
            ...
            rhou0[(j + 0) * (nx0 + 4) + (i - 1)] = rhou0[(j + 0) * (nx0 + 4) + (i + 1)];
            rhou0[(j + 0) * (nx0 + 4) + (i - 2)] = rhou0[(j + 0) * (nx0 + 4) + (i + 2)];
            rhou1[(j + 0) * (nx0 + 4) + (i - 1)] = rhou1[(j + 0) * (nx0 + 4) + (i + 1)];
            rhou1[(j + 0) * (nx0 + 4) + (i - 2)] = rhou1[(j + 0) * (nx0 + 4) + (i + 2)];
    ...
    for (int j = 2; j < 3; j++) {
        for (int i = 0; i < nx0 + 4; i++) {
            ...
            rhou0[(j - 1) * (nx0 + 4) + (i + 0)] = rhou0[(j + 1) * (nx0 + 4) + (i + 0)];
            rhou0[(j - 2) * (nx0 + 4) + (i + 0)] = rhou0[(j + 2) * (nx0 + 4) + (i + 0)];
            rhou1[(j - 1) * (nx0 + 4) + (i + 0)] = rhou1[(j + 1) * (nx0 + 4) + (i + 0)];
            rhou1[(j - 2) * (nx0 + 4) + (i + 0)] = rhou1[(j + 2) * (nx0 + 4) + (i + 0)];
    ...
    #pragma acc data copy(rho[0:(nx1+4)*(nx0+4)+(nx0+4)], rhou0[0:(nx1+4)*(nx0+4)+(nx0+4)], rhou1[0:(nx1+4)*(nx0+4)+(nx0+4)], rhoE[0:(nx1+4)*(nx0+4)+(nx0+4)], rho_old[0:(nx1+4)*(nx0+4)+(nx0+4)], rhou0_old[0:(nx1+4)*(nx0+4)+(nx0+4)], rhou1_old[0:(nx1+4)*(nx0+4)+(nx0+4)], rhoE_old[0:(nx1+4)*(nx0+4)+(nx0+4)], T[0:(nx1+4)*(nx0+4)+(nx0+4)], u0[0:(nx1+4)*(nx0+4)+(nx0+4)], u1[0:(nx1+4)*(nx0+4)+(nx0+4)], p[0:(nx1+4)*(nx0+4)+(nx0+4)], wk0[0:(nx1+4)*(nx0+4)+(nx0+4)], wk1[0:(nx1+4)*(nx0+4)+(nx0+4)], wk2[0:(nx1+4)*(nx0+4)+(nx0+4)], wk3[0:(nx1+4)*(nx0+4)+(nx0+4)])
...
#pragma acc parallel loop collapse(2)
        for (int j = 0; j < nx1 + 4; j++) {
            for (int i = 0; i < nx0 + 4; i++) {
                rho_old[(j + 0) * (nx0 + 4) + (i + 0)] = rho[(j + 0) * (nx0 + 4) + (i + 0)];
                rhou0_old[(j + 0) * (nx0 + 4) + (i + 0)] = rhou0[(j + 0) * (nx0 + 4) + (i + 0)];
                rhou1_old[(j + 0) * (nx0 + 4) + (i + 0)] = rhou1[(j + 0) * (nx0 + 4) + (i + 0)];
                rhoE_old[(j + 0) * (nx0 + 4) + (i + 0)] = rhoE[(j + 0) * (nx0 + 4) + (i + 0)];
            }
        }
